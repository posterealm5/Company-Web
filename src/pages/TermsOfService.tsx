  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-3 font-sans font-medium text-gray-700 dark:text-zinc-300">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 font-sans font-medium text-gray-700 dark:text-zinc-300">
          <div>
            <p className="font-bold text-sm uppercase tracking-wider text-brand-black dark:text-zinc-200 mb-1">When uploading your own artwork, you confirm that:</p>
          ...
          <div>
            <p className="font-bold text-sm uppercase tracking-wider text-brand-black dark:text-zinc-200 mb-1">You may not upload content that:</p>
            <ul className="list-disc pl-5 space-y-1 text-sm">
    ...
    },
    {
      ...
      content: (
        <p className="font-sans font-medium text-gray-700 dark:text-zinc-300 leading-relaxed">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 font-sans font-medium text-gray-700 dark:text-zinc-300">
          ...
          <div>
            <p className="font-bold text-xs uppercase tracking-wider text-gray-500 dark:text-zinc-400 mb-1">Posterealm reserves the right to:</p>
            <ul className="list-disc pl-5 space-y-1 text-sm">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2 font-sans font-medium text-gray-700 dark:text-zinc-300">
          <p>Production generally begins shortly after order placement.</p>
          <p className="text-sm italic border-l-4 border-brand-red pl-4 bg-brand-white/50 dark:bg-zinc-800/50 p-2">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 font-sans font-medium text-gray-700 dark:text-zinc-300">
          <div>
            <p className="font-bold text-xs uppercase tracking-wider text-gray-500 dark:text-zinc-400 mb-1">Coupons may be subject to:</p>
            <ul className="list-disc pl-5 space-y-1 text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex-1 bg-brand-white dark:bg-zinc-800 p-4 comic-border border-brand-black dark:border-zinc-700 border-2 shadow-none">
              ...
              <div className="flex flex-col gap-1 font-bold text-sm">
                <a href="https://wa.me/918949923501?text=Hi%20Posterealm,%20I%20have%20a%20question%20regarding%20your%20Terms%20of%20Service." target="_blank" rel="noopener noreferrer" className="hover:text-brand-red transition-colors text-brand-black dark:text-zinc-100">
                  WhatsApp Support
                </a>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {sections.map((sec, idx) => (
            <motion.section
              ...
              className={`bg-white dark:bg-zinc-900 comic-border border-brand-black dark:border-zinc-700 border-3 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(230,57,70,0.5)] p-6 md:p-8 flex flex-col justify-between ${sec.title === 'Contact' ? 'md:col-span-2' : ''
                }`}
            >
              <div>
                <div className="flex items-center gap-3 border-b-2 border-brand-black dark:border-zinc-700 pb-3 mb-4">
                  {sec.icon}
